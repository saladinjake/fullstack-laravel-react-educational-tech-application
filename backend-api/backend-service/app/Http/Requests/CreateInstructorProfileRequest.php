...
class CreateInstructorProfileRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            ...
            'email' => ['required', 'email', 'max:191', 'string', 'regex:/^\w+[-\.\w]*@(?!(?:outlook|gmail|hotmail|yahoo)\.com$)\w+[-\.\w]*?\.\w{2,4}$/', "unique:users,email,'.$id"],
            ...
            'experience_level' => 'required|max:2|integer',
