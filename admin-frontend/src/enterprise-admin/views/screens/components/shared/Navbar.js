...
class Navbar extends Component {
  ...
  handleSearch = (e) => {
    ...
    if (searchVal.length > 0) {
      ...
      window.location.href = (`/admin/dashboard/courses-boxes?search=${searchVal}&applied_search=sb`);
      //window.location.reload();
    }
  }
  ...
  render () {  
    return (
      <nav className="navbar col-lg-12 col-12 p-lg-0 fixed-top d-flex flex-row">
        ...
        <a className="navbar-brand brand-logo-mini align-self-center d-lg-nonec" href="!#" onClick={evt =>evt.preventDefault()}><img style={{width:"200px", height:"70px"}} src={"../../../../assets/images/Questence-logo.png"} alt="logo" /></a>
          <button className="navbar-toggler navbar-toggler align-self-center" type="button" onClick={ () => document.body.classList.toggle('sidebar-icon-only') }>
            <i className="mdi mdi-menu"></i>
          </button>
          <ul className="navbar-nav navbar-nav-left header-links align-self-center">
            <li className="nav-item font-weight-semibold d-none  d-md-flex">Dashboard</li>
            <li className="nav-item dropdown language-dropdown">
            <Dropdown>
                <Dropdown.Toggle className="nav-link count-indicator p-0 toggle-arrow-hide bg-transparent">
                  
                  <span className="profile-text font-weight-medium d-none d-md-block">Manage</span>
                </Dropdown.Toggle>
                <Dropdown.Menu className="navbar-dropdown preview-list">
                  ...
                  <Dropdown.Item className="dropdown-item preview-item d-flex align-items-center" href="!#" onClick={evt =>evt.preventDefault()}>
                    ...
                    </div>Business organizations
                  </Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>
            </li>
          </ul>
          <div className="ml-auto search-form d-none d-md-block" novalidation>
            <div className="form-group">
              <input className="form-control" id="search" type="search" className="form-control" placeholder="Search Here"  onKeyPress={evt => { 
                //evt.preventDefault() 
                console.log(evt.key)
                if(evt.key=="Enter"){
            ...
            <li className="nav-item  nav-profile border-0">
              <Dropdown>
                ...
                <Dropdown.Menu className="preview-list navbar-dropdown pb-3">
                  ...
                  <Dropdown.Item  className="dropdown-item preview-item d-flex align-items-center border-0" onClick={ evt => this.handleLogout(evt) }>
...
const QuestenceNavBAR  = connect(mapStateToProps, {
  login,
  setPrevPath,
  logOut,
})(Navbar);

export default QuestenceNavBAR;