              ...
              <div>
                ...
                <ul className="chat-list">
                  <li className="list active">
                    <div className="profile"><img src={ require("../../../../assets/images/faces/dummy_user.png")} alt="profile" /><span className="online"></span></div>
                    <div className="info">
      ...
      <li className={(props.isCompleted ? 'completed' : null)}>
          <div className="form-check">
              <label htmlFor="" className="form-check-label"> 
                  <input className="form-control" className="checkbox" type="checkbox" 
