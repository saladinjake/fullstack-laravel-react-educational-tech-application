...
const CreateCourse = (props) => {
 ...
 function  appendUserRow(id, user) {
            var html = `<div id=\"opt-row.` + id + "\" className=\"form-group row\">\n" +
                "           <div className=\"col-3\">\n" +
                "                <input required type=\"text\" className=\"form-control\" id=\"opt-type." + id + "\" name=\"opt-type." + id + "\" placeholder=\"subject\" value=\"" + user.type + "\">\n" +
                "            </div>\n" +
                "            <div className=\"col-3\">\n" +
                "                <input required type=\"text\" className=\"form-control\" id=\"opt-name." + id + "\" name=\"opt-name." + id + "\" placeholder=\"subject\" value=\"" + user.name + "\">\n" +
                "            </div>\n" +
                "            <div className=\"col-3\">\n" +
                "                <input required type=\"email\" className=\"form-control\" id=\"opt-email." + id + "\" name=\"opt-email." + id + "\" placeholder=\"subject\" value=\"" + user.email + "\">\n" +
                "            </div>\n" +
                "            <div className=\"col-2\">\n" +
                "                <input required type=\"number\" className=\"form-control\" id=\"opt-no." + id + "\" name=\"opt-no." + id + "\" placeholder=\"subject\" value=\"" + user.no + "\">\n" +
                "            </div>\n" +
        ...
        window.addMoreRows = function(id){
           var html = `<div id=\"opt-row.` + id + "\" className=\"form-group row\">\n" +
                "           <div className=\"col-3\">\n" +
                "                <input required type=\"text\" className=\"form-control\" id=\"opt-type." + id + "\" name=\"opt-type." + id + "\" placeholder=\"subject\" >\n" +
                "            </div>\n" +
                "            <div className=\"col-3\">\n" +
                "                <input required type=\"text\" className=\"form-control\" id=\"opt-name." + id + "\" name=\"opt-name." + id + "\" placeholder=\"subject\" >\n" +
                "            </div>\n" +
                "            <div className=\"col-3\">\n" +
                "                <input required type=\"email\" className=\"form-control\" id=\"opt-email." + id + "\" name=\"opt-email." + id + "\" placeholder=\"subject\" >\n" +
                "            </div>\n" +
                "            <div className=\"col-2\">\n" +
                "                <input required type=\"number\" className=\"form-control\" id=\"opt-no." + id + "\" name=\"opt-no." + id + "\" placeholder=\"subject\" >\n" +
                "            </div>\n" +
                "             <button type=\"button\" onclick=\"delRow(" + id + ")\" className=\"btn btn-danger\">Delete</button>\n" +
                "        </div> <p style=\"color:darkblue\" onclick=\"addMoreRows(" + id + ")\"> Add more to this section</p><hr />";
            $("#form-placeholder").append(html);
