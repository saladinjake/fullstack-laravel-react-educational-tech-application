  ...
  return (
    <div className="App">
      ...
      <form ref={formEl} onSubmit={handleSubmit}>
        ...
        <input className="form-control" id="name-input" name="name" placeholder="Daniel Ricciardo" />
        <label htmlFor="team-input">Team</label>
        <input className="form-control" id="team-input" name="team" placeholder="Renault" />
